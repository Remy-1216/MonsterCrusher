...
void EnemyManager::DrawEnemys()
{
	...
	if (!m_isClear1)
	{
		DrawFormatString(kRestEnemysX, kRestEnemysY, 0x000000, "残り敵数 : %d", m_enemyNumRetention1);
	}
	else if (!m_isClear2)
	{
		DrawFormatString(kRestEnemysX, kRestEnemysY, 0x000000, "残り敵数 : %d", m_enemyNumRetention2);
	}
	else if (!m_isClear3)
	{
		DrawFormatString(kRestEnemysX, kRestEnemysY, 0x000000, "残り敵数 : %d", m_enemyNumRetention3);
	}
	else if (!m_isClear4)
	{
		DrawFormatString(kRestEnemysX, kRestEnemysY, 0x000000, "残り敵数 : %d", m_enemyNumRetention4);
	}
